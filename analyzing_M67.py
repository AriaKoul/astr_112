...
'''parallax_lower = 0.001
distance_lower = 1/parallax_lower
parallax_upper = 0.00125
distance_upper = 1/parallax_upper

avg_parallax = 0.00113
...
# a parallax between 1.00 mas and 1.25 mas only.
query_result_filtered.drop(query_result_filtered[query_result_filtered['parallax'] > 1.25].index, inplace=True)
query_result_filtered.drop(query_result_filtered[query_result_filtered['parallax'] < 1.00].index, inplace=True)
